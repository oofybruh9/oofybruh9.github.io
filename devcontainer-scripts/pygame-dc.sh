...
apk update
apk add --no-cache guacamole-server guacamole-server-vnc guacamole-server-ssh guacamole-server-libs guacamole-server-encoder openjdk11-jre-headless wget python3 python3-dev py3-pip python3-venv icewm
